== Academy Air by [Code Academy](http://www.codeacademy.org)
...
3. As a user, I want to see a proﬁle page that shows how many frequent ﬂyer 
miles I’ve earned.
4. As a user, I want to make a reservation.
5. As a user, I expect my frequent ﬂyer mileage total to increase every time I 
reserve a ﬂight.
